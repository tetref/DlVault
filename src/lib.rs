...
#[derive(Debug)]
pub struct DlVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DlVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DlVault processing");
    
    let mut processor = DlVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DlVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DlVaultProcessor::new(false);
